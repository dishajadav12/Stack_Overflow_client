...
const Auth = () => {
    ...
    const handleSubmit = (e) =>{
        ...
        if(isSignup){
            if(!name){
                alert("Enter a name to contimue")
             }
            ...
            <div className='auth-container'>
                ...
                <form onSubmit={handleSubmit}>
                        ...
                        isSignup && (
                            ...
                            <input type="text" id='name' name='name' onChange={(e)=>{setName(e.target.value)}} /></label>
                        )
                        }
                    <label htmlFor="email">
                        <h4>Email</h4>
                        <input type="emai" name="email" id="email" onChange={(e)=>{setEmail(e.target.value)}}/>
                    </label>
